    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">
          {t("dashboard.welcome", { name: user?.name || "Coder" })}
        </h1>
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600">
                {t("dashboard.problemsSolved")}
              </p>
              <p className="text-2xl font-bold text-gray-900">
                {stats.problemsSolved}
              </p>
              <p className="text-sm text-gray-500">
                {t("dashboard.ofTotal", { total: stats.totalProblems })}
              </p>
            </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-green-600">{t("dashboard.faster")}</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between text-sm">
                ...
                <span>
                  {stats.currentStreak}/{stats.weeklyGoal}{" "}
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${(stats.currentStreak / stats.weeklyGoal) * 100}%`,
                  }}
                ></div>
              </div>
              <p className="text-sm text-gray-600">
                {t("dashboard.moreToGoal", {
                  count: stats.weeklyGoal - stats.currentStreak,
                })}
              </p>
            </div>
          </div>
